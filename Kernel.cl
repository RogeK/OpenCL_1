__kernel void HelloWorld(__global int* argument1, __global int* argument2, __global int* output){
        ...
        */
        ...
        //barrier that stops all work items here until all work items in the work >        barrier(CLK_LOCAL_MEM_FENCE);

        //adding the outputs for each group--------------------------------------->        int groupValue = 0;
        //TODO: Add all the work items in each work group and output the work grou>        //Expected output:
